...
public class Droplet extends Image {
     ...
     * @param player la galleda
     * @return cert si ha entrat, fals en cas contrari
     */
    public boolean inBucket(Player player) {
        ...
        Rectangle rectangleBucket = new Rectangle(player.getX(), player.getY(), player.getWidth(), player.getHeight());
