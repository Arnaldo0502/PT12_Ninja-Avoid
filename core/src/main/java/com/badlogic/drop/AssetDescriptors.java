...
public class AssetDescriptors {
    ...
    public static final AssetDescriptor<Texture> bucketTexture = new AssetDescriptor("player.png",Texture.class);
    public static final AssetDescriptor<Texture> dropletTexture = new AssetDescriptor("shuriken.png", Texture.class);
